...
public class Weapon_Hammer2 : MonoBehaviour
{
    ...
    //        var endPoint = playerController.transform.forward;
    //        startPoint.y = 0;
    //        endPoint.y = 0;
    //        var hitPoint = Vector3.zero;
    //        if (Physics.Raycast(playerController.transform.position, playerController.transform.forward, out hit, time, (int)Define.Layer.Wall))
    //        {
    //            hitPoint = hit.point;
    //        }
    //        else
    //        {
    //            hitPoint = playerController.transform.position + playerController.transform.forward * time;
    //        }
    ...
    //        lineRenderer.SetPosition(1, AttackPoint);
