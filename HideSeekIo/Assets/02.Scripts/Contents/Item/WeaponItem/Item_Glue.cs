...
using Photon.Pun;
public class Item_Glue : Item_Weapon
{
    ...
    public override void Use(PlayerController usePlayer)
    {
        ...
        {
            _weapon_Throw = Managers.Spawn.WeaponSpawn(Define.Weapon.Glue, usePlayer.GetComponent<AttackBase>()).GetComponent<Weapon_Throw>();
