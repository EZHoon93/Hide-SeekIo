...
using Photon.Pun;
public class Item_Dynamite : Item_Weapon
{
    ...
    public override void Use(PlayerController usePlayer)
    {
        ...
        {
            _weapon_Throw = Managers.Spawn.WeaponSpawn(Define.Weapon.Dynamite, usePlayer.GetComponent<AttackBase>()).GetComponent<Weapon_Throw>();
